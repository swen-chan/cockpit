...
const defaults: Record<StateKind, { title: string; detail: string }> = {
  ...
  empty: {
    ...
    detail: "The source is available but contains no eligible records.",
  },
  unavailable: {
    title: "Source unavailable",
    detail: "Other Cockpit sections can continue independently.",
  },
  error: {
    title: "Source could not be read",
    detail: "The diagnostic is intentionally bounded and contains no source content.",
  },
};
...
export function SourceState({
  ...
  return (
    <section
      className={`source-state source-state-${kind}`}
